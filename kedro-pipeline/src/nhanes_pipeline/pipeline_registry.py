...
from nhanes_pipeline.pipelines import data_ingestion, data_processing_member1, data_science_member1
...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "__default__": ingestion_pipeline + processing_member1_pipeline + data_science_member1_pipeline
    }
